    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.html">Home</a> &nbsp;/&nbsp; <span>Three Column</span>
            </div>
        ...
        <h3>Static Image</h3>        
          <img src="<?= base_url() ?>webtemplates/big-orange/images/2048.jpg" alt="">
           ...
           <div id="myCarousel" class="carousel slide">
              <div class="carousel-inner">
                ...
                <img src="<?= base_url() ?>webtemplates/big-orange/images/5.jpg" class="img-polaroid" alt="">
                </div>
				
                <div class="item">
                <img src="<?= base_url() ?>webtemplates/big-orange/images/6.jpg" class="img-polaroid" alt="">
                </div>
				
                <div class="item">
                <img src="<?= base_url() ?>webtemplates/big-orange/images/7.jpg" class="img-polaroid" alt="">
                </div>
