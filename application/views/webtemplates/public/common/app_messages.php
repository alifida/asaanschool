...
<div id="appErrors" class="server_messeges">
<div class=" alert alert-danger message_container">
<button type="button" class="close" id="dismiss_appErrors"
		onclick="$('#appErrors').slideUp();">
...
<div id="appMessages" class="server_messeges">
	<div class=" alert alert-success message_container">
		<button type="button" class="close" id="dismiss_appMessages"
			onclick="$('#appMessages').slideUp();">
...
<div id="appNotifications" class="server_messeges">
	<div class=" alert  alert-info ssage_container">
		<button type="button" class="close" id="dismiss_app_notifications"
			onclick="$('#appNotifications').slideUp();">
