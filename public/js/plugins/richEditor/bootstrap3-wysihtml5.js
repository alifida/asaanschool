!function($, wysi) {
    ...
    var tpl = {
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<div class='col-lg-12' id='gallery_in_editor_popup'></div><script>load_gallery_images('gallery_in_editor_popup');targetControleForImagePath='.bootstrap-wysihtml5-insert-image-url';</script>"+
                "</div>" +
                "<div class='modal-footer'>" +
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["../public/css/bootstrap3-wysiwyg5-color.css"], // (path_to_project/lib/css/bootstrap3-wysiwyg5-color.css)
        locale: "en"
    };
